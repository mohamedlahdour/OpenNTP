...
!==============================================================================
       ...
       do k0 = 1,ng
          ...
          k1 = k1 + totNFM 
       enddo
       2000 format(t3,"Iteration",i6,":",8x,"======>",8x,"keff  = ",F9.6,8x,"======>",8x,"res  = ",e10.3)
...
!BL19
subroutine title1()       
       write(*,FMT='(/20(A/))') '________________________________________________________________________'
       write(*,FMT=*) '				  Version Number: 1.2'
       write(*,FMT=*) '     Copyright:		2015-2019 FS-Tetouan University Abdelmalk Essaadi'
       write ( *, FMT=* ) '.'
       write ( *, FMT=* ) '   FORTRAN90 version'  
       write ( *, FMT=* ) '   The Method of Characteristics MOC'  
       write ( *, FMT=* ) '   Calculation of 1D Discrete Angle and Spatial Domain'
